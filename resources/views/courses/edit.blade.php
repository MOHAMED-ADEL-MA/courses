                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('instructor_id') is-invalid @enderror"
                                    ...
                                    <!-- المقارنة هنا تحدد الخيار المختار -->
                                    <option value="{{ $instructor->id }}" {{ old('instructor_id', $course->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('hours') is-invalid @enderror" id="hours"
                                    name="hours" value="{{ old('hours', $course->hours) }}">
                                @error('hours')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
